     ...
     <!---------------------------基础信息表格--------------------------------->
        <div style="margin:30px 0 0">
            ...
            <!-- :row-class-name="getRowClassName"
                ...
                <!-- <el-table-column fixed="right" label="处理" v-if="this.message.mark !== 'AUD_LED'" align="center" width="100%"> -->
        ...
        methods: {
            ...
            async getBusList() {
                ...
                //获得不同池子的所有业务信息的函数
                    ...
                    const { data: res } = await this.$http.get("/basicInfo/basicinfolist",{
                        params: {
            ...
            loadOnCondition(){
                ...
                if(this.message.busteam === '' && this.message.bustype === '' 
                                    && this.message.lowrisk === '' && (this.message.resSdate === '' || this.message.resSdate === null)
                                    && (this.message.resEdate === '' || this.message.resEdate === null) && this.message.bustatus === '' && this.message.auditype === '' 
                                    && this.message.state === ''){
                    // console.log('我走的是通路1')
                    this.getBusList();  
                }else{
