        ...
        <el-card >
            ...
            <el-tabs v-model="activeName" @tab-click="tabClick">
                <el-tab-pane label="业务列表" name="AUD_0">
                    <manage-list v-bind:message="bus" ref="allBus" character="AUD_0"></manage-list>
                </el-tab-pane>
                <el-tab-pane label="预约业务" name="AUD_1">
                    <manage-list v-bind:message="bus" ref="reserveBus" character="AUD_1"></manage-list>
                </el-tab-pane>
                <el-tab-pane label="接件业务" name="AUD_2">
                    <manage-list v-bind:message="bus" ref="receiveBus" character="AUD_2"></manage-list>
                </el-tab-pane>
                <el-tab-pane label="在审业务" name="AUD_3">
                    <manage-list v-bind:message="bus" ref="audingBus" character="AUD_3"></manage-list>
                </el-tab-pane>
                <el-tab-pane label="待完善业务" name="AUD_4">
                    <manage-list v-bind:message="bus" ref="waitBus" character="AUD_4"></manage-list>
                </el-tab-pane>
                <el-tab-pane label="已完成业务" name="AUD_5">
                    <manage-list v-bind:message="bus" ref="doneBus" character="AUD_5"></manage-list>
                </el-tab-pane>
                <el-tab-pane label="已退件业务" name="AUD_6">
                    <manage-list v-bind:message="bus" ref="giveupBus" character="AUD_6"></manage-list>
                </el-tab-pane>
                <el-tab-pane label="已失效业务" name="AUD_7">
                    <manage-list v-bind:message="bus" ref="outimeBus" character="AUD_7"></manage-list>
                </el-tab-pane>
                <!----------------------我的挂件子部分------------------>
            </el-tabs>
        </el-card>
